...
$Id: Base.pod,v 1.10 2013/10/04 21:44:19 paul Exp $
...
Run a general search using GeneralSearch interface.

=item general_search_meta

use markup from general search interface to display meta information.
